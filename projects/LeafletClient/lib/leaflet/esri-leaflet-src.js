...
//测试人：潘波
  ...
  at: function(latlng){
	...
	//修改坐标为默认的经纬度转换为米
	//测试人：潘波
	var point= this._map.options.crs.projection.project(latlng);
	this.params.geometry = [point.x,point.y];
    //this.params.geometry = [latlng.lng*scale+19770.13390320944, latlng.lat*scale+23421.69110343433];
    this.params.geometryType = 'esriGeometryPoint';
    return this;
  },
